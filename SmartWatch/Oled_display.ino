...
void Oled_display::display_string(const char* str, int x, int y) {
  ...
  u8g2.drawStr(0, 30, timeStr);  // Display the time
  u8g2.setFont(u8g2_font_ncenB12_tr);
  u8g2.drawStr(x, y, str);  // draw centered text
  u8g2.setFont(u8g2_font_ncenB08_tr);


  String name_str = firstName + "'s watch";
...
// str2 : Second string
// x1 : 1st string x-axis, low value to move to left of the screen; Positive value to move the text to the right
// y1 : 1st string y-axis, high or positive value to move text down; low or negative value to move text up the display
// x2 : 2nd string x-axis, low value to move to left of the screen; Positive value to move the text to the right
