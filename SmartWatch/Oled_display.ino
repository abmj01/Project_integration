...
void Oled_display::display_string(const char* str, int x, int y) {
  ...
  // Add the battery status here
  display_battery_status(currentVoltage, currentPercentage, 0, 0);
...
void Oled_display::display_battery_status(float voltage, float percentage, int x, int y) {
